...
class Home extends Component {
    ...
    componentDidMount() {
        ...
        fetch(baseUrl + "movies?status=PUBLISHED")
            ...
            .then(data => this.setState({ upcomingMovies: data.movies }))
            .catch(error => console.log("Error fetching upcoming movies", error));

        // Get released movies
        fetch(baseUrl + "movies?status=RELEASED")
            .then(response => response.json())
            .then(data => this.setState({ releasedMovies: data.movies }))
            .catch(error => console.log("Error fetching released movies", error));
